            ...
            <div className={"pt-24"}>
                <div className={"mx-auto my-0 w-[1333px] flex flex-col items-center"}>
                    ...
                    <div className={"flex justify-between w-3/4 pt-10"}>
                        <div className={"w-1/3 border-t-2 border-l-2 border-b-2 border-white p-5 pt-10 pb-10"}>
                        ...
                        <div className={"w-1/3 border-l border-t-2 border-b-2 border-white p-5 pt-10 pb-10"}>
                            <div className={"flex flex-row items-center gap-2"}>
                                <div>
                                    <Image src={"/expertise/frontend.png"} alt={"react"} width={50} height={50}/>
                                </div>
                        ...
                        <div className={"w-1/3 border-l border-t-2 border-b-2 border-r-2 border-white p-5 pt-10 pb-10"}>
                            <div className={"flex flex-row items-center gap-2"}>
                                <div>
                                    <Image src={"/expertise/frontend.png"} alt={"react"} width={50} height={50}/>
                                </div>
                    ...
                    <div className={"pt-20 flex flex-col"}>
                        ...
                        <div className={"flex justify-between pt-10"}>
                            <div className={"text-center text-white leading-10"}>
                                <Image src={"/programming-languages/logo-typescript.svg"} alt={"ts"} width={50} height={50}/>
                                <span>TS</span>
                            </div>
                            <div className={"text-center text-white leading-10"}>
                                <Image src={"/programming-languages/logo-javascript.svg"} alt={"js"} width={50} height={50}/>
                                <span>JS</span>
                            </div>
                            <div className={"text-center text-white"}>
                                <Image src={"/programming-languages/logo-python.svg"} alt={"py"} width={50} height={50}/>
                                <span>Python</span>
                            </div>
                            <div className={"text-center text-white"}>
                                <Image src={"/programming-languages/logo-java.svg"} alt={"java"} width={38} height={30}/>
                                <span>Java</span>
                            </div>
                        </div>
                    </div>
